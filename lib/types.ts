...
// Espelham o modelo de dados usado em lib/cloud.ts (snapshot no
// Firestore). Autenticação (senha) é responsabilidade do Firebase
// Auth e não faz parte do estado do app.
// ============================================================
